...
This is an overview the internal structure of the code, meant for readers who
...
of files as above, with, for example, classes in :file:`baseband/vdif/header.py`
inheriting from classes in :file:`baseband/vlbi_base/header.py`.
