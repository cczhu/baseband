...
Baseband and Astropy-Helpers together (which, among other things, enables the
test suite and Sphinx documentation builder).  :file:`version.py` is
auto-generated by :file:`setup.py` in the main directory.
